 ...
 *  
 *******************************************************************************/
package edu.utah.ece.async.backend.learn.parameterestimator;
...
import edu.utah.ece.async.backend.analysis.dynamicsim.hierarchical.methods.HierarchicalODERKSimulator;
import edu.utah.ece.async.backend.learn.genenet.Experiments;
import edu.utah.ece.async.backend.learn.genenet.SpeciesCollection;
import edu.utah.ece.async.backend.learn.parameterestimator.methods.sres.EvolutionMethodSetting;
import edu.utah.ece.async.backend.learn.parameterestimator.methods.sres.Modelsettings;
import edu.utah.ece.async.backend.learn.parameterestimator.methods.sres.ObjectiveSqureError;
import edu.utah.ece.async.backend.learn.parameterestimator.methods.sres.SRES;
