...
//		}
		...
		if(edu.utah.ece.async.dataModels.verification.platu.main.Options.getTimingAnalysisType()
				.equals("zone")){
		...
		else if (edu.utah.ece.async.dataModels.verification.platu.main.Options.getTimingAnalysisType()
		.equals("octagon")){
