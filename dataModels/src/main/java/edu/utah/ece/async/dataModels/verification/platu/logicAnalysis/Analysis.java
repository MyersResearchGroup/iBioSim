...
import edu.utah.ece.async.dataModels.verification.platu.MDD.Mdd;
import edu.utah.ece.async.dataModels.verification.platu.MDD.mddNode;
...
import edu.utah.ece.async.dataModels.verification.platu.markovianAnalysis.ProbGlobalState;
import edu.utah.ece.async.dataModels.verification.platu.markovianAnalysis.ProbGlobalStateSet;
import edu.utah.ece.async.dataModels.verification.platu.markovianAnalysis.ProbLocalStateGraph;
import edu.utah.ece.async.dataModels.verification.platu.partialOrders.DependentSet;
import edu.utah.ece.async.dataModels.verification.platu.partialOrders.DependentSetComparator;
import edu.utah.ece.async.dataModels.verification.platu.partialOrders.ProbStaticDependencySets;
import edu.utah.ece.async.dataModels.verification.platu.partialOrders.StaticDependencySets;
...
import edu.utah.ece.async.dataModels.verification.platu.por1.AmpleSet;
...
import edu.utah.ece.async.dataModels.verification.timed_state_exploration.zone.TimedStateSet;
import edu.utah.ece.async.dataModels.verification.timed_state_exploration.zoneProject.EventSet;
import edu.utah.ece.async.dataModels.verification.timed_state_exploration.zoneProject.TimedPrjState;
...
//				curStateArray = curStateArrayList.pop();
	...
	public Stack<State[]> search_dfs_por(final StateGraph[] lpnList, final State[] initStateArray, LPNTranRelation lpnTranRelation, String approach) {	
		...
		//init por
		edu.utah.ece.async.dataModels.verification.platu.por1.AmpleSet ampleClass = new edu.utah.ece.async.dataModels.verification.platu.por1.AmpleSet();
