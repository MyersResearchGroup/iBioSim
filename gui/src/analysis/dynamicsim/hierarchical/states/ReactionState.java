...
public abstract class ReactionState extends SpeciesState
{
	...
	public ReactionState(HashMap<String, Model> models, String bioModel,
			String submodelID)
	{
		...
		reactionToPropensityMap = new TObjectDoubleHashMap<String>(
		...
		reactionToFormulaMap = new HashMap<String, ASTNode>(
				(int) (getNumReactions() * 1.5));
