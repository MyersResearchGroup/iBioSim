...
public class SetupTest
{
	...
	// {
	// String SBMLFile =
	// "./gui/src/analysis/dynamicsim/hierarchical/tests/resources/test00.xml";
	// HierarchicalODERKSimulator odeSim = new
	// HierarchicalODERKSimulator(SBMLFile, "", 10);
	...
	// {
	// String SBMLFile =
	// "./gui/src/analysis/dynamicsim/hierarchical/tests/resources/test03.xml";
	...
	// {
	// String SBMLFile =
	// "./gui/src/analysis/dynamicsim/hierarchical/tests/resources/test04.xml";
	// HierarchicalODERKSimulator odeSim = new
	// HierarchicalODERKSimulator(SBMLFile, "", 10);
	// odeSim.simulate();
	//
	...
	// {
	// String SBMLFile =
	// "./gui/src/analysis/dynamicsim/hierarchical/tests/resources/test05.xml";
	// HierarchicalSSADirectSimulator ssaSim = new
	// HierarchicalSSADirectSimulator(SBMLFile, "", "", 1, 10, 0, 1, 0, 0,
	// false);
	// ssaSim.simulate();
	//
	// }
	...
	// {
	// String SBMLFile =
	// "./gui/src/analysis/dynamicsim/hierarchical/tests/resources/test06.xml";
	// HierarchicalSSADirectSimulator ssaSim = new
	// HierarchicalSSADirectSimulator(SBMLFile, "", "", 1, 10, 0, 1, 0, 0,
	// false);
	// ssaSim.simulate();
	...
	// {
	// String SBMLFile =
	// "./gui/src/analysis/dynamicsim/hierarchical/tests/resources/test07.xml";
	// HierarchicalSSADirectSimulator ssaSim = new
	// HierarchicalSSADirectSimulator(SBMLFile, "", "", 1, 10, 0, 1, 0, 0,
	// false);
	// ssaSim.simulate();
	...
	// {
	// String SBMLFile =
	// "./gui/src/analysis/dynamicsim/hierarchical/tests/resources/test11.xml";
	// HierarchicalSSADirectSimulator ssaSim = new
	// HierarchicalSSADirectSimulator(SBMLFile, "", "", 1, 10, 0, 1, 0, 0,
	// false);
