...
public class BioSim implements MouseListener, ActionListener, FocusListener {
	...
	public BioSim(boolean lema) {
		...
		createAnal = new JMenuItem("Analysis");
		createLearn = new JMenuItem("Learn");
		createSbml = new JMenuItem("Create SBML File");
		createSynth = new JMenuItem("Synthesis");
		createVer = new JMenuItem("Verification");
		...
		// newMenu.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N, ShortCutKey
