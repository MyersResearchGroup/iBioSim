    	...
    	private void createGlobalArray(String var, List<Integer> dimensionList){
    		...
    		while(!arrayQueue.isEmpty()){
    			...
    			for(int i = 0; i < arraySize; i++){
    				...
    				element.setType(verification.platu.lpn.VarType.GLOBAL);
    				array.add(i, element);
    				varList.add(element);
    		...
    		newArray.setType(verification.platu.lpn.VarType.GLOBAL);
    	...
    	private void createInputArray(String var, List<Integer> dimensionList){
    		...
    		while(!arrayQueue.isEmpty()){
    			...
    			for(int i = 0; i < arraySize; i++){
    				...
    				int index = VariableIndex++;
    				VarNode element = new VarNode(name, index);
    				element.setType(verification.platu.lpn.VarType.INPUT);
    				array.add(i, element);
    				varList.add(element);
    		...
    		ArrayNode newArray = new ArrayNode(var, topLevelArray, dimensionList.size(), dimensionList, varList);
    		newArray.setType(verification.platu.lpn.VarType.INPUT);
    		VarNodeMap.put(var, newArray);
    //  		VarCountMap.put(var, 0);
    		Inputs.add(var);
        ...
        try {
            ...
            match(input,GREATER,FOLLOW_GREATER_in_main162); 
            				...
            				for(Entry<String, Integer> e : GlobalVarHashMap.entrySet()){
            	    			...
            	    			globalVarNode.setType(verification.platu.lpn.VarType.GLOBAL);
                ...
                cnt22++;
            				...
            				while(!arrayQueue.isEmpty()){
            					...
            					for(int i = 0; i < arraySize; i++){
            						...
            						int index = VariableIndex++;
            						VarNode element = new VarNode(name, index);
            						element.setType(verification.platu.lpn.VarType.INTERNAL);
            						array.add(i, element);
            						varList.add(element);
            				...
            				newArray.setType(verification.platu.lpn.VarType.INTERNAL);
            ...
            switch (alt45) {
                case 1 :
                    ...
                    var2=(Token)match(input,ID,FOLLOW_ID_in_assignment1793); 
                    	    		...
                    	    		if(ArrayNode.class.isAssignableFrom(node1.getClass())){
                       				...
                       				if(node1.getType() == verification.platu.lpn.VarType.INTERNAL || node1.getType() == verification.platu.lpn.VarType.OUTPUT){
                ...
                case 2 :
                    ...
                    state._fsp--;
                    	    		...
                    	    		if(ArrayNode.class.isAssignableFrom(node.getClass())){
                       				...
                       				if(node.getType() == verification.platu.lpn.VarType.INTERNAL || node.getType() == verification.platu.lpn.VarType.OUTPUT){
                ...
                case 3 :
                    ...
                    state._fsp--;
                    	    		...
                    	    		if(arrayNode.getType() == verification.platu.lpn.VarType.INTERNAL || arrayNode.getType() == verification.platu.lpn.VarType.OUTPUT){
