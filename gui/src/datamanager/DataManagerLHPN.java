...
public class DataManagerLHPN extends JPanel implements ActionListener, TableModelListener,
	...
	public DataManagerLHPN(String directory, BioSim biosim) {
...
class TableSorterLHPN extends TableMap implements TableModelListener {
	/**
	 * 
	 */
	...
	public TableSorterLHPN() {
	}

	public TableSorterLHPN(TableModel model, String[] species) {
		setModel(model);
...
class TableHeaderSorterLHPN extends MouseAdapter {

	private TableSorter sorter;

	private JTable table;

	private TableHeaderSorterLHPN() {
	}

	public static void install(TableSorter sorter, JTable table) {
		TableHeaderSorterLHPN tableHeaderSorter = new TableHeaderSorterLHPN();
...
class TableMapLHPN extends AbstractTableModel implements TableModelListener {
