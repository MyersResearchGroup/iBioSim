 ...
 *  
 *******************************************************************************/
package edu.utah.ece.async.biosim.gui.learnView;
...
import edu.utah.ece.async.biosim.gui.util.*;
import edu.utah.ece.async.biosim.learn.AMSModel.DMVCrun;
import edu.utah.ece.async.biosim.learn.AMSModel.LearnModel;
import edu.utah.ece.async.biosim.learn.AMSModel.Variable;
 ...
 * @version %I%
 */
public class LearnViewLEMA extends JPanel implements ActionListener, Runnable, ItemListener, Observer { // added ItemListener SB
