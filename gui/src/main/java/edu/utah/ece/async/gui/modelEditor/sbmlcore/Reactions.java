 ...
 *  
 *******************************************************************************/
package edu.utah.ece.async.gui.modelEditor.sbmlcore;
...
public class Reactions extends JPanel implements ActionListener, MouseListener {
	...
	public Reactions(BioModel gcm, Boolean paramsOnly, ArrayList<String> getParams, String file, ArrayList<String> parameterChanges, 
		...
		edu.utah.ece.async.dataModels.biomodel.util.Utility.sort(reacts);
	...
	public void reactionsEditor(BioModel bioModel, String option, String reactionId, boolean inSchematic) {
		...
		edu.utah.ece.async.dataModels.biomodel.util.Utility.sort(reacParams);
		...
		edu.utah.ece.async.dataModels.biomodel.util.Utility.sort(reacta);
		...
		edu.utah.ece.async.dataModels.biomodel.util.Utility.sort(proda);
		...
		edu.utah.ece.async.dataModels.biomodel.util.Utility.sort(modifierArray);
	...
	public void productsEditor(BioModel bioModel, String option, String selectedProductId, SpeciesReference product,
		...
		edu.utah.ece.async.dataModels.biomodel.util.Utility.sort(speciesList);
