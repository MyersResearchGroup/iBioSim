 ...
 *  
 *******************************************************************************/
package edu.utah.ece.async.biosim.gui.verificationView;
...
import edu.utah.ece.async.lema.verification.lpn.LpnDecomposition.Component;
import edu.utah.ece.async.lema.verification.lpn.LpnDecomposition.LpnComponentList;
...
public class VerificationView extends JPanel implements ActionListener, Runnable, Observer {
	...
	private AbstractionPanel abstPane;
...
//			}
	...
	public AbstractionPanel getAbstPane() {
		return abstPane;
	}
