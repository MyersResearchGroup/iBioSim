 ...
 *
 */
public class VerilogParserSRLatch_Test {
	...
	public static void setupTest() throws ParseException, SBOLValidationException, VerilogCompilerException, XMLStreamException, IOException, BioSimException, org.apache.commons.cli.ParseException, SBOLConversionException {
		...
		verilog_imp = compiledVerilog.parseVerilogFile(new File(TestingFiles.verilogSRLatch_impFile));
		Assert.assertNotNull(verilog_imp);
		imp_alwaysblk = verilog_imp.getAlwaysBlock(0);
		
		verilog_tb = compiledVerilog.parseVerilogFile(new File(TestingFiles.verilogSRLatch_tbFile));
