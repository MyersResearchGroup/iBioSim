...
/**
 * Test technology mapping on Nand spec. mapped to a Nand Cello gate.
 * 
 * @author Tramy Nguyen
 */
public class NandSpecification_Test {
	...
	public static void setupTest() throws SBOLTechMapException, GateGenerationExeception, SBOLValidationException, IOException, SBOLConversionException { 
		...
		setupOpt.setLibraryFile(TestingFiles.NAND1_LibSize1);
