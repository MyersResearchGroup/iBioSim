...
/**
 * Test 2 crossed coupled NOR gate design that was compiled from a verilog expression to an SBOL data model
 * @author Tramy Nguyen
 *
 */
public class SBOL_Example4 extends AbstractVerilogParserTest{
	...
	public static void setupTest() {
		...
		String[] cmd = {"-v", reader.getFile("contAssign5.v"), "-sbol", "-od", CompilerTestSuite.outputDirectory};
	...
	@Test
	public void Test_CD_gateInputs() {
		List<String> expected_id = Arrays.asList("CD0_s", "CD1_r", "CD2_q", "CD3_qnot");
	...
	public void Test_CD_gate() {
		List<String> expected_id = Arrays.asList("CD4_norGate", "CD5_norGate");
		for(String id : expected_id) {
			ComponentDefinition cd = sbolDoc.getComponentDefinition(id, "1.0");
			Assert.assertNotNull(cd);
			Assert.assertEquals(1, cd.getTypes().size());
	...
	public void Test_FC_Inputs() {
		List<String> expected_id = Arrays.asList("FC0_s", "FC1_r");
		for(String id : expected_id) {
	...
	public void Test_FC_output() {
		List<String> expected_id = Arrays.asList("FC2_q", "FC3_qnot");
		for(String id : expected_id) {
			FunctionalComponent fc = sbolDesign.getFunctionalComponent(id);
			Assert.assertNotNull(fc);
			Assert.assertEquals(AccessType.PUBLIC, fc.getAccess());
	...
	public void Test_FC_gate() {
		List<String> expected_id = Arrays.asList("FC4_norGate", "FC5_norGate");
		for(String id : expected_id) {
			FunctionalComponent fc = sbolDesign.getFunctionalComponent(id);
			Assert.assertNotNull(fc);
			Assert.assertEquals(AccessType.PUBLIC, fc.getAccess());
	...
	public void Test_InteractionSize() {
		Assert.assertEquals(6, sbolDesign.getInteractions().size());
	}
	...
	public void Test_Interaction1() {
		...
		Assert.assertEquals(sbolDesign.getFunctionalComponent("FC3_qnot"), p1.getParticipant());
		...
		Assert.assertEquals(sbolDesign.getFunctionalComponent("FC4_norGate"), p2.getParticipant());
	...
	public void Test_Interaction2() {
		...
		Assert.assertNotNull(p1);
		Assert.assertEquals(sbolDesign.getFunctionalComponent("FC1_r"), p1.getParticipant());
		Assert.assertEquals(1, p1.getRoles().size());
		Assert.assertEquals(SystemsBiologyOntology.INHIBITOR, p1.getRoles().iterator().next());
	...
	public void Test_Interaction3() {
		...
		Assert.assertNotNull(p1);
		Assert.assertEquals(sbolDesign.getFunctionalComponent("FC4_norGate"), p1.getParticipant());
		Assert.assertEquals(1, p1.getRoles().size());
		...
		Assert.assertNotNull(p2);
		Assert.assertEquals(sbolDesign.getFunctionalComponent("FC2_q"), p2.getParticipant());
		Assert.assertEquals(1, p2.getRoles().size());
	...
	public void Test_Interaction4() {
		...
		Assert.assertNotNull(p1);
		Assert.assertEquals(sbolDesign.getFunctionalComponent("FC2_q"), p1.getParticipant());
		Assert.assertEquals(1, p1.getRoles().size());
		Assert.assertEquals(SystemsBiologyOntology.INHIBITOR, p1.getRoles().iterator().next());
	...
	public void Test_Interaction5() {
		...
		Assert.assertNotNull(p1);
		Assert.assertEquals(sbolDesign.getFunctionalComponent("FC0_s"), p1.getParticipant());
		Assert.assertEquals(1, p1.getRoles().size());
		Assert.assertEquals(SystemsBiologyOntology.INHIBITOR, p1.getRoles().iterator().next());
	...
	@Test
	public void Test_Interaction6() {
		Interaction interaction = sbolDesign.getInteraction("I5");
		Assert.assertNotNull(interaction);
		Assert.assertEquals(1, interaction.getTypes().size());
		Assert.assertEquals(SystemsBiologyOntology.GENETIC_PRODUCTION, interaction.getTypes().iterator().next());
		
		Participation p1 = interaction.getParticipation("P10");
		Assert.assertNotNull(p1);
		Assert.assertEquals(sbolDesign.getFunctionalComponent("FC5_norGate"), p1.getParticipant());
		Assert.assertEquals(1, p1.getRoles().size());
		Assert.assertEquals(SystemsBiologyOntology.PROMOTER, p1.getRoles().iterator().next());
		
		Participation p2 = interaction.getParticipation("P11");
		Assert.assertNotNull(p2);
		Assert.assertEquals(sbolDesign.getFunctionalComponent("FC3_qnot"), p2.getParticipant());
		Assert.assertEquals(1, p2.getRoles().size());
		Assert.assertEquals(SystemsBiologyOntology.PRODUCT, p2.getRoles().iterator().next());
	}
}
