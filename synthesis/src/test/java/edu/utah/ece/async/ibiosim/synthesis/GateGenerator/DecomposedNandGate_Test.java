...
public class DecomposedNandGate_Test {
	...
	public static void setupTest() throws SBOLValidationException, IOException, SBOLConversionException, GateGenerationExeception { 
		SBOLDocument inFile = SBOLReader.read(new File(TestingFiles.NAND1_LibSize1));
		...
		decomposedGraph = nandGate.getDecomposedGraph();
		
	}
	
	@Test
	public void Test_graphSize() {
		Assert.assertEquals(10, decomposedGraph.topologicalSort().size());
	}
