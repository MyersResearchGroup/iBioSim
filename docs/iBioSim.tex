...
\noindent
There are three types of rules: algebraic, assignment, and rate rules which are in the following form:
\begin{center}
\begin{tabular}{|c|c|c|}
\hline
...
Monte carlo & mpde & An incremental SSA using marginal probability density evolution \\ \hline   
Monte carlo & mp & An incremental SSA using the mean path \\ \hline    
Monte carlo & mp-adaptive & An incremental SSA using the mean path and adaptive step size\\ \hline     
Monte carlo & mp-event & An incremental SSA using the mean path and event count step size \\ \hline     
...
\section{\label{SBMLMath}Model Math Formulas}
