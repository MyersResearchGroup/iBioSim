...
public class HierarchicalTestSuiteRunner {
  static Set<String> unsupportedTags = new HashSet<>(Arrays.asList("fbc:Objective", "CSymbolDelay", "StoichiometryMath", "FastReaction", "AlgebraicRule", "ConversionFactors", "comp:ConversionFactor", "comp:ExtentConversionFactor", "comp:TimeConversionFactor", "RandomEventExecution"));
  ...
  public static void main(String[] args) {
    ...
    for (; start <= end; start++) {
      ...
      try {
        ...
        totalTime += (endTime - initTime) / 1000;
  ...
  private static boolean checkResults(String inputDir, String outputDir, String testcase) {
    ...
    if (ref == null || sim == null) { return false; }
