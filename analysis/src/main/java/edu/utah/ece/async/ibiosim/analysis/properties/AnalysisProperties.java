...
public final class AnalysisProperties extends CoreObservable {
	...
	private String filename, id, root, directory, outDir, modelFile, propertiesFile, sim, simProp, fileStem;
	 ...
	 *
	 * @param id
	 *          - task id of the analysis
	 * @param modelFile
	 *          - name of the model associated with the analysis.
	 * @param root
	 *          - directory of the project.
	 * @param isGui
	 *          - flag that indicates if the properties is created from the GUI.
	 */
	 ...
	 *
	 * @param the
	 *          new path for the output directory.
	 */
	 ...
	 *
	 * @param new
	 *          path for the project root directory.
	 */
